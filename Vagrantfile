Vagrant.configure(2) do |config|
	config.vm.define "devops-box" do |devbox|
		...
		#devbox.vm.provision :shell, privileged: false,	inline: "git clone git://github.com/robbyrussell/oh-my-zsh.git /home/vagrant/.oh-my-zsh"
		#devbox.vm.provision :shell, privileged: false, 	inline: "cp  /home/vagrant/.oh-my-zsh/templates/zshrc.zsh-template  /home/vagrant/.zshrc"
